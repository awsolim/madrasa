...
export default async function Page({ params }: { params: Promise<{ slug: string; programId: string }> }) {
  ...
  return <><PageTitleBar title="Audit Trail" backHref={`/m/${slug}/teacher/classes/${programId}/finances`} backLabel="Finances" tone="teal" /><FinanceAuditTrail programId={programId} /></>;
}
